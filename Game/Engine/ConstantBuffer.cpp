...
void ConstantBuffer::Init(uint32 size, uint32 count)
{
	...
	// 0 256 512 768
	_elementSize = (size + 255) & ~255; // ~256 = 1111 0000 -> 256배수가 되도록 뒤 비트는 날림
	_elementCount = count;
...
void ConstantBuffer::CreateView()
{
	...
	_handleIncrementSize = DEVICE->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV); // 핸들별 간격
